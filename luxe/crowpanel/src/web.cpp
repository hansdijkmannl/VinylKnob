...
<div class="card">
  <div class="row">
    <div style="flex:3"><label>IP of the Pi</label><input id="breinHost" placeholder="192.168.1.175"></div>
  </div>
...
async function save(){
  ...
  for(const k of ['avrHost','breinHost','wifiSsid','wifiPass'])b[k]=$(k).value;
