...
is served by luister.py on ports 8791 and 80; everything under /api/ here is
...
async def index(request):
    ...
    The web interface became one page with tabs, and the ears (luister.py) serve
...
def main():
    ...
    print(f"\n  Brain API on port {PORT}. The web interface runs with the ears "
          "(luister.py) and reaches it here.")
